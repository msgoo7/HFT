...
namespace API2
{
  namespace CONSTANTS
  {
    ...
    const unsigned short CMD_ExchangeId_WOL = 84;
    const unsigned short CMD_ExchangeId_MAX = 85;
    ...
    /**
     * @brief CMD_CommandCategory_WOL_DISCONNECTED
     */
    const unsigned short CMD_CommandCategory_WOL_DISCONNECTED = 190;
